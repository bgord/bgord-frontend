!(function (e, t) {
    ...
    E = /*#__PURE__*/ (function () {
      ...
      return (
        ...
        (e.clearAll = function (e) {
          return function () {
            for (var t, n = p(e); !(t = n()).done; ) t.value.clear();
          };
        }),
        e
      );
  ...
  function ie(e) {
    return function () {
      for (var t, n = p(e); !(t = n()).done; ) (0, t.value)();
    };
  }
  var le = {
      ...
      Truncates: function () {
        ...
        return s.default.createElement(
          ...
          s.default.createElement(
            "label",
            f({ className: "c-label" }, t.label.props),
            "Length",
          ),
          s.default.createElement(
            "input",
  ...
  be.empty = { result: [], meta: { exhausted: !0 } };
  ...
  (e.API = function (e, t) {
    return fetch(
      e,
      f({ mode: "same-origin", redirect: "follow" }, t, {
        headers: f(
          {
    ...
    (e.OutboundLink = function (e) {
      ...
      return s.default.createElement(
        t || "a",
        f({ target: "_blank", rel: "noreferer noopener" }, n),
      );
    }),
    (e.Pagination = be),
    (e.Rhythm = function (e) {
        ...
        void 0 === e && (e = 12),
        {
          times: function (t) {
            var n = e * t,
              r = {
                height: { height: we(n) },
                minHeight: { minHeight: we(n) },
                maxHeight: { maxHeight: we(n) },
                width: { width: we(n) },
                minWidth: { minWidth: we(n) },
                maxWidth: { maxWidth: we(n) },
                square: { height: we(n), width: we(n) },
              },
              a = {
                height: { style: { height: we(n) } },
                minHeight: { style: { minHeight: we(n) } },
                maxHeight: { style: { maxHeight: we(n) } },
                width: { style: { width: we(n) } },
                minWidth: { style: { minWidth: we(n) } },
                maxWidth: { style: { maxWidth: we(n) } },
                square: { style: { height: we(n), width: we(n) } },
              };
            return f({ px: we(n), raw: n, style: a }, r);
          },
        }
      );
    }),
    ...
    (e.Switch = function (e) {
      ...
      return s.default.createElement(
        ...
        s.default.createElement(
          "label",
          f({ className: "c-switch-label" }, n.label.props),
