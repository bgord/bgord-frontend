...
const U = { Days: O, Hours: k, Minutes: N, Seconds: R };
function _() {
  return Date.now();
}
function j() {
...
var Oe;
function ke(t) {
  const [n, r] = e.useState(Oe.initial),
    a = e.useRef(null),
    o = h("duration", 0),
    u = h("currentTime", 0),
    i = h("volume", 1),
  ...
  return {
    ...
    actions: {
      play: function () {
        a.current && (a.current.play(), r(Oe.playing));
      },
      pause: function () {
        a.current && (a.current.pause(), r(Oe.paused));
      },
      mute: function () {
        a.current && ((a.current.volume = 0), i.set(0));
      },
    ...
    meta: {
      state: n,
      isInitial: n === Oe.initial,
      isReady: n === Oe.ready,
      isPlaying: n === Oe.playing,
      isPaused: n === Oe.paused,
      matches: (e) => e.some((e) => e === n),
      percentage: { raw: s, formatted: `${s}%` },
      currentTime: { raw: u.value, formatted: p.format(u.value) },
      duration: { raw: o.value, formatted: p.format(o.value) },
