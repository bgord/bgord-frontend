...
var p = /*#__PURE__*/ (function () {
  ...
  g = function (e, n) {
    return fetch(
      e,
      f({ mode: "same-origin", redirect: "follow" }, n, {
        headers: f(
          {
  ...
  E = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.clearAll = function (e) {
        return function () {
          for (var n, t = m(e); !(n = t()).done; ) n.value.clear();
        };
      }),
      e
    );
...
function N(e, n) {
  ...
  return f(
    r.value === n.enum.default
      ? { sortFn: k, options: Object.keys(n.options) }
      : {
          sortFn: null != (t = n.options[r.value]) ? t : k,
...
var H = { Days: j, Hours: R, Minutes: U, Seconds: _ };
function B() {
  return Date.now();
}
function q() {
...
function Be(e) {
  ...
  return n.createElement(
    t || "a",
    f({ target: "_blank", rel: "noreferer noopener" }, r),
  );
}
function qe(e) {
  return function () {
    for (var n, t = m(e); !(n = t()).done; ) (0, n.value)();
  };
}
var ze = {
...
function We(e) {
  ...
  return n.createElement(
    ...
    n.createElement(
      "label",
      f({ className: "c-switch-label" }, r.label.props),
  ...
  Ye = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.formDatetimeLocal = function (e) {
        var n = e - U(new Date().getTimezoneOffset()).ms;
  ...
  return (
    void 0 === e && (e = 12),
    {
      times: function (n) {
        ...
        return f({ px: fn(t), raw: t, style: u }, r);
      },
    }
  );
}
