...
type ReorderingTransferType<T extends ReorderingBaseItemType = ReorderingBaseItemType> = {
...
type UseReorderingConfigType<T extends ReorderingBaseItemType = ReorderingBaseItemType> = {
  correlationId: ReorderingCorrelationIdType;
  initialItems: T[];
...
type UseReorderingReturnType<T extends ReorderingBaseItemType = ReorderingBaseItemType> = {
  items: T[];
  enabled: boolean;
  props: {
